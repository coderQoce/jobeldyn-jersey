...
const ProductSection = ({ onAddToCart }) => {
  ...
  const products = {
    ...
    special: [
      { id: 90, name: 'Barcelona Special Edition Jersey 2', category: 'Special', price: 20000.00, playerPrice: 23000.00, image: '/Assets/products/Special Edition Jersey/barca.jpg', playerImage: '/Assets/products/Special Edition Jersey/barca.jpg', sizes: ['M', 'L', 'XL', 'XXL'] },
      { id: 88, name: 'Portugal Special Edition Jersey', category: 'Special', price: 20000.00, playerPrice: 23000.00, image: '/Assets/products/Special Edition Jersey/portugal-special.jpg', playerImage: '/Assets/products/Special Edition Jersey/portugal-special.jpg', sizes: ['M', 'L', 'XL', 'XXL'] }
    ],
    club: [
